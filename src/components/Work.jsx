            ...
            <div className="wrapper">
                <div className="project">
                    ...
                    <div className="links">
                        ...
                        <a href="https://salt-platform.vercel.app/index" target="_blank" rel="noreferrer">Try the app</a>
                    </div>
                </div>
                <div className="project">
                    ...
                    <div className="links">
                        ...
                        <a href="www.google.com" target="_blank" rel="noreferrer">Try the app</a>
                    </div>
                </div>
                <div className="project">
                    ...
                    <div className="links">
                        ...
                        <a href="https://lucid-dubinsky-eb7b37.netlify.app/" target="_blank" rel="noreferrer">Try the app</a>
                    </div>
                </div>
                <div className="project">
                    ...
                    <div className="links">
                        ...
                        <a href="https://flamboyant-heisenberg-5beb54.netlify.app/" target="_blank" rel="noreferrer">Try the app</a>
                    </div>
                </div>
            </div>
